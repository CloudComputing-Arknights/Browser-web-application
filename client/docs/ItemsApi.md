...
let categoryId: string; //Filter by item\'s category (optional) (default to undefined)
...
| **categoryId** | [**string**] | Filter by item\&#39;s category | (optional) defaults to undefined|
